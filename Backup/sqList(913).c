...
#define SQ_MAXSIZE 20 					/* 存储空间初始分配量 */
typedef struct
{
	ElemType data[SQ_MAXSIZE+1];  		/* 数组，存储数据元素 */
	int length;                      	/* 线性表当前长度 */
}SqList;
...
* 作者:  日南方  6/15/2020
**************************************************************************************************/
Boolean sqDelMin(SqList *L ,sqElemType *value)
{
...
* 作者:  日南方  10/19/2020
**************************************************************************************************/
Boolean sqDelSeqListMin2Max2(SqList *L, sqElemType min_data, sqElemType max_data)
{
...
* 作者:  日南方  6/17/2020
**************************************************************************************************/
Boolean sqDelSeqListEqual(SqList *L)
{
	int i, k;
	if (L.length==0)
	{
...
* 作者:  日南方  6/17/2020
**************************************************************************************************/
Boolean sqUnionSeqList(SqList A, SqList B, SqList *C)
{
...
* 作者:  日南方  6/18/2020
**************************************************************************************************/
int16_t arSeqArraySearchInsert(int16_t A[], int size_max,sqElemType x)
{
...
* 作者:  日南方  10/19/2020
**************************************************************************************************/
int findMissMin(int A[],int size)
{
	 int i, *B;
